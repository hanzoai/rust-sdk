...
impl SpecializedAgent for ExplorerAgent {
    ...
    fn tools(&self) -> Vec<ToolDefinition> {
        vec![
            ...
            ToolDefinition::new("search_code", "Search for patterns")
                .with_parameters(serde_json::json!({
                    "type": "object",
                    "properties": {
                        "pattern": { "type": "string" },
            ...
            ToolDefinition::new("find_definition", "Find definition of a symbol")
                .with_parameters(serde_json::json!({
                    "type": "object",
                    "properties": {
                        "symbol": { "type": "string" },
            ...
            ToolDefinition::new("get_ast", "Get AST structure of a file")
                .with_parameters(serde_json::json!({
                    "type": "object",
                    "properties": {
                        "path": { "type": "string" },
