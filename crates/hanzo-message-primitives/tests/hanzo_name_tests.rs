...
mod tests {
    ...
    fn test_valid_names() {
        ...
        for name in valid_names {
            ...
            assert!(
                result.is_ok(),
                "Expected {} to be valid, but it was not.",
                name
            );
        }
    }
    ...
    fn test_invalid_names_with_repair() {
        ...
        for name in invalid_names {
            ...
            assert!(
                result.is_err(),
                "Expected {} to be invalid, but it was not.",
                name
            );
        }
    }
    ...
    fn test_no_hanzo_suffix() {
        ...
        assert!(
            result.is_ok(),
            "Expected the name to be formatted correctly"
        );
    ...
    fn test_from_node_and_profile_names_valid() {
        ...
        let result = HanzoName::from_node_and_profile_names(
            "bob.hanzo".to_string(),
            "profileBob".to_string(),
        );
    ...
    fn test_from_node_and_profile_names_invalid() {
        ...
        let result =
            HanzoName::from_node_and_profile_names("b!ob".to_string(), "profileBob".to_string());
    ...
    fn test_has_device() {
        let hanzo_name =
            HanzoName::new("@@dave.hanzo/profileDave/device/myDevice".to_string()).unwrap();
    ...
    fn test_has_no_subidentities() {
        ...
        assert!(
            hanzo_name.has_no_subidentities(),
            "Name should have no subidentities"
        );
    }
    ...
    fn test_get_profile_name_string() {
        ...
        assert_eq!(
            hanzo_name.get_profile_name_string(),
            Some("profilefrank".to_string())
        );

        let hanzo_name =
            HanzoName::new("@@frank.hanzo/profile_1/device/device_1".to_string()).unwrap();
        assert_eq!(
            hanzo_name.get_profile_name_string(),
    ...
    fn test_extract_node() {
        let hanzo_name =
            HanzoName::new("@@henry.hanzo/profileHenry/device/myDevice".to_string()).unwrap();
    ...
    fn test_contains() {
        ...
        let alice_agent =
            HanzoName::new("@@alice.hanzo/profileName/agent/myChatGPTAgent".to_string()).unwrap();
        let alice_device =
            HanzoName::new("@@alice.hanzo/profileName/device/myDevice".to_string()).unwrap();
    ...
    fn test_does_not_contain() {
        ...
        let alice_profile = HanzoName::new("@@alice.hanzo/profileName".to_string()).unwrap();
        let alice_agent =
            HanzoName::new("@@alice.hanzo/profileName/agent/bobsGPT".to_string()).unwrap();
        let bob_agent =
            HanzoName::new("@@bob.hanzo/profileName/agent/myChatGPTAgent".to_string()).unwrap();
    ...
    fn test_get_fullname_string_without_node_name() {
        ...
        let hanzo_name4 =
            HanzoName::new("@@alice.hanzo/profileName/device/myPhone".to_string()).unwrap();
        assert_eq!(
